...
router.register(r'medicine-adjustments', MedicineStockAdjustmentViewSet, basename='medicine-adjustment')
...
urlpatterns = [
    ...
    path("customer-debt-statistics/", CustomerDebtStatisticsView.as_view(), name="customer-debt-statistics"),
    path('customer-debt-dynamic-statistics/', CustomerDebtDynamicStatisticsAPIView.as_view(), name='customer_debt_dynamic_statistics'),
    
    path('medicine-statistics/', MedicineStatisticsView.as_view(), name='medicine-statistics'),
    path('medicine-sales-chart/', MedicineSalesChartView.as_view(), name='medicine-sales-chart'),
    path('medicine-stock-chart/', MedicineStockChartView.as_view(), name='medicine-stock-chart'),
    path('medicine-search/', MedicineSearchView.as_view(), name='medicine-search'),
    path('medicine-barcode/', MedicineBarcodeView.as_view(), name='medicine-barcode'),
    path('medicine-expiry-report/', MedicineExpiryReportView.as_view(), name='medicine-expiry-report'),
    path('medicine-low-stock-report/', MedicineLowStockReportView.as_view(), name='medicine-low-stock-report'),
    path("customer-medicine/<int:customer_id>/", CustomerMedicineView.as_view(), name="customer_medicine")
]