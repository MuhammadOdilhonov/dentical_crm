...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Additional Info', {'fields': ('role', 'clinic','branch', 'phone_number', 'specialization', 'status', 'reason_holiday', 'start_holiday', 'end_holiday', 'telegram_chat_id')}),
    )
...
admin.site.register(DentalServiceCategory)